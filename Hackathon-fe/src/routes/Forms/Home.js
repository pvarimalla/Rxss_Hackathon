    ...
    return (
      <Fragment>
        ...
        >
          ...
          >
                <Paper elevation={16}>
                   <h1 style={{padding: "10px 20px", textAlign: "Center", color: "#6496ec"}}>Details</h1>
            {/* <div className={classes.container}> */}
              <FormControl className={classes.formControl}>
              <RadioGroup name="member_uid" >
                 <FormControlLabel value="1" control={<Radio />} label="Enter a Group_Id" onClick={() => this.setState({showMemberUid: true}) }/>
