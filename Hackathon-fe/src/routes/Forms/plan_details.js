    ...
    useEffect(() => {
      //  fetch("https://jsonplaceholder.typicode.com/users")
       ...
       method: 'GET'})
        ...
        //   setData(resp)
        // })
        // axios.get("http://localhost:8080/api/pdf-parse").then(resp => {
        //    setData(resp)})
      }, [])
      ...
      const receiveValue = (value) => {console.log("value received from Uploadfile",value)}
    return (
      <div className="App">
        {/* <h1 align="center">React-App</h1> */}
        <h4 align='center'>Plan_details Table</h4>
